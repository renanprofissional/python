...
# criar uma classe que vai gerir todas as informações que o objeto terá
# objeto = vendedor
...
# não foi necessário criar um novo bloco de código para esse vendedor
# foi possível criar um sistema que atende todos os casos padrões de usuários acessantes
