...
if objetivo == "ganhar massa":
    print("Você precisa focar em treinos de hipertrofia combinados com uma dieta hipercalórica.");
elif objetivo == "perder peso":
    print("Você precisa focar em treinos aeróbicos combinados com uma dieta restritiva.");
else:
    print("Desculpe, não conseguimos entender o que você escreveu. Tente novamente mais tarde.");
